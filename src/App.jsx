        ...
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-start">
          ...
          <div>
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              Я Марат — делаю фотореалистичные кадры, которые продают идею проекта ещё до стройки: понятные инвестору,
              убедительные для покупателя и технически корректные для подрядчиков.
            </p>
            <p className="text-gray-300 leading-relaxed">
              Быстро включаюсь в работу, первые превью через 48 часов. Правки — до совпадения с ожиданиями.
            </p>
          </div>
